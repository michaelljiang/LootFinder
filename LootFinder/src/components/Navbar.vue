      ...
      <div class="lg:flex lg:items-center lg:justify-center">
        ...
        >
          <div class="flex flex-col -mx-6 lg:flex-row items-center lg:mx-8 justify-center">
            ...
            <router-link
              to="/browse"
              class="px-3 py-2 mx-3 mt-2 text-logoBrown transition-colors font-semibold duration-300 transform rounded-md lg:mt-0 hover:bg-nav hover:text-white"
            >
              Browse
            </router-link>
            <router-link
            ...
            <router-link
              ...
              class="relative px-3 py-2 mx-3 mt-2 text-logoBrown transition-colors font-semibold duration-300 transform rounded-md lg:mt-0 hover:bg-nav hover:text-white"
            >
              Inbox
              <span
                v-if="unreadCount > 0"
