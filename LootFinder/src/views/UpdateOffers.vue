  ...
  <div class="container mx-auto p-6">
    ...
    <ul v-else>
      <li
        ...
        :key="offer.id"
        class="border rounded p-4 mb-4 shadow relative"
        :class="{ 'bg-gray-300 opacity-70': offer.sold }"
      >
    ...
    methods: {
      ...
      async markSold(offer) {
        ...
        try {
          ...
          this.successMessage = newSoldStatus
            ? 'Offer marked as sold!'
            : 'Offer marked as unsold!';
          setTimeout(() => (this.successMessage = ''), 3000);
        } catch (error) {
